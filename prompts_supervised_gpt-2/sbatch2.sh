#!/bin/bash
#SBATCH --job-name=2sbatch
#SBATCH -o gypsum_logs/stdout/gpt2_prompt_logit_softmax_atsc_restaurants_multiple_prompts_cross_domain.txt
#SBATCH -e gypsum_logs/stderr/gpt2_prompt_logit_softmax_atsc_restaurants_multiple_prompts_cross_domain.err
#SBATCH --ntasks=1
