#!/bin/bash
#SBATCH --job-name=3sbatch
#SBATCH -o gypsum_logs/stdout/gpt2_prompt_logit_softmax_atsc_laptops_multiple_prompts.txt
#SBATCH -e gypsum_logs/stderr/gpt2_prompt_logit_softmax_atsc_laptops_multiple_prompts.err
#SBATCH --ntasks=1
