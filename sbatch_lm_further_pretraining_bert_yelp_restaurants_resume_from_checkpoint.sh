...
#SBATCH -o gypsum_logs/stdout/lm_further_pretraining_bert_yelp_restaurants_%j.txt
#SBATCH -e gypsum_logs/stderr/lm_further_pretraining_bert_yelp_restaurants_%j.err
#SBATCH --ntasks=1
...
papermill --autosave-cell-every 300 --progress-bar --log-output --log-level INFO \
          ...
          -p weight_decay 0.01 \
          -p checkpoint_path progress/lm_further_pretraining_bert_yelp_restaurants_bseoh_2021-03-07--09_59_12/results/checkpoint-484208 \
