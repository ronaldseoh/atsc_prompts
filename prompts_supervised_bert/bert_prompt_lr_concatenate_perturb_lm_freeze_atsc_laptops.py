...
experiment_id_prefix_override = 'bert_prompt_lr_concatenate_perturb_lm_freeze_atsc'

# Random seed
random_seeds = [696]#s, 685, 683, 682, 589]
...
if run_single_prompt:
    ...
    for seed, lm_model_name, prompt_key in tqdm.tqdm(itertools.product(random_seeds, lm_model_paths.keys(), sentiment_prompts.keys())):
        ...
        parameters_to_inject = {
            ...
            'training_lm_freeze': training_lm_freeze,
