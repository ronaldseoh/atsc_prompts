#!/bin/bash
#SBATCH --job-name=lm_further_pretraining_gpt-2_amazon_electronics
#SBATCH -o gypsum_logs/stdout/lm_further_pretraining_gpt-2_amazon_electronics_%j.txt
#SBATCH -e gypsum_logs/stderr/lm_further_pretraining_gpt-2_amazon_electronics_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=lm_further_pretraining_gpt-2_amazon_electronics
