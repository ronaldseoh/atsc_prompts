...
# path to pretrained MLM model folder or the string "gpt-2-base-uncased"
lm_model_paths = {
...
experiment_id_prefix_override = 'gpt2_' + str(training_dataset_few_shot_size) + '_shot_' + 'prompt_logit_softmax_sum_logits_atsc'
